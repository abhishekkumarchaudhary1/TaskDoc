...
const Footer = () => {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    TaskDoc helps you manage documents and tasks effortlessly, keeping everything organized and accessible in one place.
    </p>
 ...
 <br />
 <br />
    <p className='text-center text-gray-700 transition hover:text-gray-700/75 font-bold'>© 2024 TaskDoc. All rights reserved.</p>
  </div>
</footer>
    </div>
  )
